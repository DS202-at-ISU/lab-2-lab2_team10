...
The pattern of the scatter plot follows a slightly positive, linear correlation. Many outliers are present across all years.  One oddity the clear line of points across the chart where Sale Price = 0.  Also, because the dataset compiles properties sold from 2017 to 2022, there is a clear increase in properties after 2017 due to all the new constructions that are also accounted for.
